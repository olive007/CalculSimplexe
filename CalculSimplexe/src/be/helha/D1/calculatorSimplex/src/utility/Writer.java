...
/**
 *
 * Cette classe est une interface afin d'afficher les données dans la console.
 * 
 * Vu que le projet doit être modifié afin d'utilisé avec une GUI, cette sera complètement changé lors de la modification
 *
 * @author Olivier
 * 
 */
